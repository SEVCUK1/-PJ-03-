...
def respond_send_email(respond_id):
    ...
    send_mail(
        ...
        message=f'Доброго дня, {respond.post.author}, ! На ваше объявление есть новый отклик!\n'
                f'Прочитать отклик:\nhttp://127.0.0.1:8000/responses/{respond.id}',
        from_email='shevchukolejka@yandex.ru',
...
def respond_accept_send_email(response_id):
    ...
    send_mail(
        ...
        message=f'Доброго дня, {respond.author}, Автор объявления {respond.title} принял Ваш отклик!\n'
